...
public class ScaleInTransformer extends BasePageTransformer {
    ...
    public ScaleInTransformer(ViewPager2.PageTransformer pageTransformer) {
        this(DEFAULT_MIN_SCALE, pageTransformer);
    }


    public ScaleInTransformer(float minScale, ViewPager2.PageTransformer pageTransformer) {
        mMinScale = minScale;
