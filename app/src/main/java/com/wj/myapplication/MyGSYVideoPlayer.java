...
public class MyGSYVideoPlayer extends GSYVideoPlayer {
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, MyGSYVideoPlayer.this);
        }
        prepareVideo();
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            MyGSYVideoPlayer gsyVideoPlayer = (MyGSYVideoPlayer) gsyBaseVideoPlayer;
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(MyGSYVideoPlayer standardGSYVideoPlayer) {
