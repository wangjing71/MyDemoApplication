...
public class PagerSlidingTabStrip1 extends HorizontalScrollView {
	...
	private boolean widthLengthBySetting = false;
	...
	public void setWidthLengthBySetting(boolean widthLengthBySetting) {
		this.widthLengthBySetting = widthLengthBySetting;
	}
	...
	public void setSelectTitleSize(int size) {
		this.selectTitleSize = size;
		invalidate();
	}
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(onTabClickListener!=null){
					onTabClickListener.tabClick(position,((TextView)tab).getText().toString());
				}
			}
		});
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if (i == selectedPosition) {
					...
					tab.setTextSize(TypedValue.COMPLEX_UNIT_PX, selectTitleSize);
				}
			}
		}
...
//        canvas.drawRect(lineLeft + (lineRight-lineLeft-indicatorPadding)/2, height - indicatorHeight, lineRight-(lineRight-lineLeft-indicatorPadding)/2, height, rectPaint);

		if(widthLengthBySetting){ //自己设置宽度
	...
	public void setTitleSelectColor(String color) {
		setTitleSelectColor(Color.parseColor(color));
	}
	...
	public void setTextSize(int textSizePx) {
		...
		selectTitleSize = this.tabTextSize;
		updateTabStyles();
	}
	...
	public void setTabBackground(String resId) {
		this.tabBackgroundResId = Color.parseColor(resId);
	}
	...
	public interface onTabClickListener{
		void tabClick(int position, String title);
	}
